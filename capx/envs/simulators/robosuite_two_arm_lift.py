...
class RobosuiteTwoArmLiftEnv(BaseEnv):
    ...
    def _emit_step_record(self, action: np.ndarray) -> None:
        """Build a 16-D two-arm Step and fire the recorder callback."""
        ...
        # Two-arm layout: action[0:7]=r0 joints, action[7]=r0 gripper, action[8:15]=r1 joints, action[15]=r1 gripper
